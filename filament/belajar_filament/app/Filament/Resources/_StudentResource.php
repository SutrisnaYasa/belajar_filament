...
class _StudentResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\_ListStudents::route('/'),
            'create' => Pages\_CreateStudent::route('/create'),
            'edit' => Pages\_EditStudent::route('/{record}/edit'),
        ];
    }
}
